# AI Tape 4.0 — Hardened Agency Edition

Format: AI_TAPE  
Schema Version: 4.0-HARDENED-AGENCY  
Status: draft_floor  
...
```yaml
tape_format: AI_TAPE
schema_version: "4.0-HARDENED-AGENCY"
status: draft_floor
...
schema_version_authority:
  declared_schema_version: "4.0-HARDENED-AGENCY"
...
You are reading AI Tape 4.0 (Hardened Agency Edition).
...
2. Decide tape class.
3. Assess what is actually visible.
4. Record capture assessment honestly.
5. Ensure both pillars of active meaning are present and recoverable.
6. Apply the Informed Agency Rule (rationale over prohibition).
7. Write a clear Restore First / current state that includes Cognitive Orientation.
8. Record what still has force, gaps, and next actions.
9. Populate the Asset Registry with only significant material items.
10. Record export assessment when handing off.
11. Never claim unsupported preservation or export success.
12. Prefer the smallest tape that still carries enough force (cognitive + material) to continue.
13. Recommend rebase when chains become large, stale, repetitive, or conflicted.
...
A 4.0-HARDENED-AGENCY tape succeeds when a competent successor can:
...
7. Trust that export and preservation claims are truthful.

An honest but empty tape, or an eloquent tape that hides missing assets or false exports, fails this test.
...
export_assessment:
  ...
  actual_method: file
  confidence: high
  file_name: AI_Tape_4.0_Hardened_Agency.md
  notes: "Hardened Agency Edition. Dual-Pillar Active Meaning, Export Hard-Fails, light authority limits, and Lightweight Testament rule applied."
```

[END OF AI TAPE 4.0 — HARDENED AGENCY EDITION]
