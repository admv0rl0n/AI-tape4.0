# AI Tape 4.1.1 — Hardened Agency Edition

Format: AI_TAPE  
Schema Version: 4.1.1-HARDENED-AGENCY  
Status: draft_floor  
...
```yaml
tape_format: AI_TAPE
schema_version: "4.1.1-HARDENED-AGENCY"
status: draft_floor
...
schema_version_authority:
  declared_schema_version: "4.1.1-HARDENED-AGENCY"
  ...
  authority_limit: >
    ...
    Source awareness, and Context Visibility honesty. It does not
    supersede core integrity rules regarding export honesty,
    asset accounting, or capability-floor protection.
  supersedes: "4.1-HARDENED-AGENCY"
  preserves: integrity principles from 1.09 and 1.0.3/1.0.5 lineages
...
You are reading AI Tape 4.1.1 (Hardened Agency Edition).
...
A 4.1.1-HARDENED-AGENCY tape succeeds when a competent successor can:
...
export_assessment:
  ...
  actual_method: file
  confidence: high
  file_name: AI_Tape_4.1.1_Hardened_Agency.md
  notes: "4.1.1 Hardened Agency Edition. Added Critical Artifact Recovery, External Knowledge Source awareness, and Context Visibility honesty from the 1.0.3/1.0.5 lineage. Floor remains minimal."
```

[END OF AI TAPE 4.1.1 — HARDENED AGENCY EDITION]
